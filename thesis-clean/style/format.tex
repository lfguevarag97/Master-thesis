...
%     colorlinks=true, % colores en los enlaces hipertexto
%     pdfpagemode=None, % sin modo de página específico
%     pdfpagelayout=SinglePage, % apertura en una sola página
%     pdffitwindow=true, % las páginas se ajustan completamente a la ventana
%     linkcolor=linkcol, % color de los enlaces internos
%     citecolor=citecol, % color de los enlaces de citas
%     urlcolor=linkcol % color de los enlaces URL
% }
