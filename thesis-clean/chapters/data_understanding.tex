...
% Description: CRISP DM Stage #2 - Detailed description of existing datasets, registers and relevant information related to the business model.
% ============================================
...
\begin{figure}[H]
	 \begin{center}
	 \includegraphics[scale=0.515]{regleche1.jpg}
	 \end{center}
...
\begin{figure}[H]
	 \begin{center}
	 \includegraphics[scale=0.345]{ejtaurus.jpg}
	 \end{center}
...
\begin{figure}[H]
	 \begin{center}
	 \includegraphics[scale=0.92]{ejpesos.jpg}
	 \end{center}
