...
% Description: Theorical context of the problem needed to understand the development of the project.
% ============================================
...
\begin{figure}[H]
 \begin{center}
 \includegraphics[scale=0.9]{dibujito1.png}
 \end{center}
...
\begin{figure}[H]
 \begin{center}
 \includegraphics[scale=0.75]{dibujito2.png}
 \end{center}
...
\begin{figure}[H]
 \begin{center}
 \includegraphics[scale=0.75]{dibujito3.png}
 \end{center}
...
\begin{figure}[H]
 \begin{center}
 \includegraphics[scale=0.55]{dibujito4.png}
 \end{center}
...
\begin{figure}[H]
 \begin{center}
 \includegraphics[scale=0.8]{estabulado.png}
 \end{center}
...
\begin{figure}[H]
 \begin{center}
 \includegraphics[scale=0.74]{silvopastoril.png}
 \end{center}
...
\begin{figure}[H]
 \begin{center}
 \includegraphics[scale=0.9]{razaslecheras.png}
% \end{center}
 \caption{En la primer fila de izquierda a derecha se observan ejemplares de las razas Normando, Simmental; seguido de las razas Holstein y Jersey en la fila inferior. Tomada de \cite{contextoganadero} \label{razaslecheraspng}}
  \end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.5]{ganadcarne2.png}
\end{center}
...
\begin{figure}[H]
 \begin{center}
 \includegraphics[scale=0.56]{cuadrorazas.png}
% \end{center}
...
\subsubsection{Agua}
	...
	\begin{figure}[H]
	 \begin{center}
	 \includegraphics[scale=0.67]{agua.png}
	 \end{center}
	 \caption{Hidratación del ganado. Tomada de \cite{contextoganadero}.	\label{aguapng}}
	\end{figure}
...
Este componente se suministra mediante azúcares, almidones, celulosa, entre otros, los cuales aportan grandes cantidades de energía mas no de proteína, razón por la cual se deben suministrar de forma complementaria.
	\begin{figure}[H]
	 \begin{center}
	 \includegraphics[scale=0.5]{melazacana.png}
	 \end{center}
...
Estos nutrientes son fundamentales especialmente durante los periodos de sequía, por consiguiente, se optan por fuentes altas en proteína como leguminosas forrajeras, el Maní, Leucaena y el más común, los pastos de forraje verde.
	\begin{figure}[H]
	 \begin{center}
	 \includegraphics[scale=0.8]{proteina.png}
	 \end{center}
...
Suministradas en cantidades pequeñas aplicadas comúnmente en animales cuya alimentación se basa en forrajes secos,  o en animales enfermos convalecientes, desnutridos o durante épocas de sequía prolongada.
	\begin{figure}[H]
	 \begin{center}
	 \includegraphics[scale=0.6]{leguminosas.png}
	 \end{center}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=1.18]{splines.png}
...
\begin{enumerate}
    ...
    \begin{equation*}
        \mathcal{L}(x_{1},x_{2},...,x_{n}|\mu,\sigma) = \prod_{i=1}^{n}\mathcal{L}(x_{i}|\mu,\sigma)
    \end{equation*}
    \item Finalmente, se procede a determinar el logaritmo natural para obtener la verosimilitud logarítmica, obteniéndose que:
    \begin{equation}
        \log\mathcal{L}(x_{1},x_{2},...,x_{n}|\mu,\sigma) = \sum_{i=1}^{n}\left[-\left(\frac{1}{2}\right)\log(2\pi\sigma^{2})-\frac{(x_{i}-\mu)^{2}}{2\sigma^{2}}\right]
    \end{equation}
\end{enumerate}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{tesispptsena.png}
